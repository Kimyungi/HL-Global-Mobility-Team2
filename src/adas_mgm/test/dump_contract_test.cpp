...
int main() {
  ...
  check(good,true,"v46 round trip");
  ...
  check(field(1,45),false,"old v45 width-based obstacle entry");
  check(field(1,44),false,"old v44 obstacle-clear release");
  check(field(1,43),false,"old v43 ESTOP detection boundary");
  check(field(1,42),false,"old v42 avoidance marker semantics");
