...
from native_footprint import footprint_clear
...
print(json.dumps(result,indent=2));Path(__file__).with_name('fast_native_results.json').write_text(json.dumps(result,indent=2))
