...
def main():
    ...
    print('State v09.17; Yongin: default course=yongin_no_parking (saved CSV); course=yongin is explicit opt-in; shared traffic/GPS zone [3]; dump v44. ESTOP: CSV zone [6] station; hold until front corridor clear; no reverse')
