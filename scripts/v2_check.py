...
def main():
    ...
    print('Parking policy:', 'T parking holds route endpoint through forward return; parallel keeps endpoint cancellation'
    ...
    print('State v09.17; Halla map: halla_0919; shared traffic/GPS zone [3]; dump v38. ESTOP: measured stop 6s / reverse 1m / measured stop')
