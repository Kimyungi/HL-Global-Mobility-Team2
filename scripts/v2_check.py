...
def main():
    ...
    print('State v09.17; Yongin: course=yongin (01..07) or yongin_no_parking (saved CSV); shared traffic/GPS zone [3]; dump v44. ESTOP: CSV zone [6] station; hold until front corridor clear; no reverse')
