...
def main():
    ...
    print('State v09.17; Yongin: default course=yongin_no_parking (saved CSV); course=yongin is explicit opt-in; shared traffic/GPS zone [3]; dump v46. ESTOP: CSV zone [6] station, front 5m, cluster >=5 points with gaps <=5cm; release after 7s measured standstill; no reverse')
